								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_685c32072fd20">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_685c32072fd20" data-allow-clear="true">
																<option></option>
										...
										<div class="card-body pt-0">
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														<div class="symbol symbol-45px me-5">
															<span class="symbol-label bg-light">
																@if($customer->image)
																	<img src="{{ asset('storage/' . $customer->image) }}" class="h-75 align-self-center" />
																@else
														...
														<div class="d-flex flex-column">
															<span class="text-gray-800 fw-bold">{{ $customer->nama }}</span>
														</div>
													</td>
													...
													<td>
														<span class="badge
															@if($customer->level === 'Gold') badge-light-warning
															@elseif($customer->level === 'Silver') badge-light-secondary
