									...
									<div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
										...
										<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('ecommerce') ? 'active' : ''}}" href="{{route('dashboard.ecommerce')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('projects') ? 'active' : ''}}" href="{{route('dashboard.projects')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('onlinecourse') ? 'active' : ''}}" href="{{route('dashboard.onlinecourse')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('marketing') ? 'active' : ''}}" href="{{route('dashboard.marketing')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('overview') ? 'active' : ''}}" href="{{route('userprofile.overview')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('project') ? 'active' : ''}}" href="{{route('userprofile.project')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Projects</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('campaigns') ? 'active' : ''}}" href="{{route('userprofile.campaigns')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('documents') ? 'active' : ''}}" href="{{route('userprofile.documents')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('followers') ? 'active' : ''}}" href="{{route('userprofile.followers')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('activity') ? 'active' : ''}}" href="{{route('userprofile.activity')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('overview1') ? 'active' : ''}}" href="{{route('account.overview')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Overview</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('settings') ? 'active' : ''}}" href="{{route('account.settings')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('security') ? 'active' : ''}}" href="{{route('account.security')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('activity1') ? 'active' : ''}}" href="{{route('account.activity')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Activity</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('billing') ? 'active' : ''}}" href="{{route('account.billing')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('statements') ? 'active' : ''}}" href="{{route('account.statements')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('referrals') ? 'active' : ''}}" href="{{route('account.referrals')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('api') ? 'active' : ''}}" href="{{route('account.api')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('logs') ? 'active' : ''}}" href="{{route('account.logs')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
													...
													<div class="menu-sub menu-sub-accordion menu-active-bg">
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('signin') ? 'active' : ''}}" href="{{route('corporate-layout.authentication.sign-in')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('signup') ? 'active' : ''}}" href="{{route('corporate-layout.authentication.sign-up')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('twofactor') ? 'active' : ''}}" href="{{route('corporate-layout.authentication.two-factor')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('ResetPassword') ? 'active' : ''}}" href="{{route('corporate-layout.authentication.reset-password')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('NewPassword') ? 'active' : ''}}" href="{{route('corporate-layout.authentication.new-password')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
												...
												<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
													...
													<div class="menu-sub menu-sub-accordion menu-active-bg">
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('signin1') ? 'active' : ''}}" href="{{route('overlay-layout.authentication.sign-in')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Sign-in</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('signup1') ? 'active' : ''}}" href="{{route('overlay-layout.authentication.sign-up')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Sign-up</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('twofactor1') ? 'active' : ''}}" href="{{route('overlay-layout.authentication.two-factor')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Two-Factor</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('ResetPassword1') ? 'active' : ''}}" href="{{route('overlay-layout.authentication.reset-password')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Reset Password</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('NewPassword1') ? 'active' : ''}}" href="{{route('overlay-layout.authentication.new-password')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">New Password</span>
												...
												<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
													...
													<div class="menu-sub menu-sub-accordion menu-active-bg">
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('signin2') ? 'active' : ''}}" href="{{route('creative-layout.authentication.sign-in')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Sign-in</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('signup2') ? 'active' : ''}}" href="{{route('creative-layout.authentication.sign-up')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Sign-up</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('twofactor2') ? 'active' : ''}}" href="{{route('creative-layout.authentication.two-factor')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Two-Factor</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('ResetPassword2') ? 'active' : ''}}" href="{{route('creative-layout.authentication.reset-password')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Reset Password</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('NewPassword2') ? 'active' : ''}}" href="{{route('creative-layout.authentication.new-password')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">New Password</span>
												...
												<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
													...
													<div class="menu-sub menu-sub-accordion menu-active-bg">
														...
														<div class="menu-item">
															<!--begin:Menu link-->
																<a class="menu-link {{ request()->is('signin3') ? 'active' : ''}}" href="{{route('fancy-layout.authentication.sign-in')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Sign-in</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('signup3') ? 'active' : ''}}" href="{{route('fancy-layout.authentication.sign-up')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Sign-up</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('twofactor3') ? 'active' : ''}}" href="{{route('fancy-layout.authentication.two-factor')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Two-Factor</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
														<a class="menu-link {{ request()->is('ResetPassword3') ? 'active' : ''}}" href="{{route('fancy-layout.authentication.reset-password')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Reset Password</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('NewPassword3') ? 'active' : ''}}" href="{{route('fancy-layout.authentication.new-password')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">New Password</span>
												...
												<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
													...
													<div class="menu-sub menu-sub-accordion menu-active-bg">
														...
														<div class="menu-item">
															<!--begin:Menu link-->
																<a class="menu-link {{ request()->is('WelcomeMessage') ? 'active' : ''}}" href="{{route('email-templates.authentication.welcome-message')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('ResetPassword4') ? 'active' : ''}}" href="{{route('email-templates.authentication.reset-password')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Reset Password</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('subscription') ? 'active' : ''}}" href="{{route('email-templates.authentication.subscription-confirmed')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('card') ? 'active' : ''}}" href="{{route('email-templates.authentication.card-declined')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('promo1') ? 'active' : ''}}" href="{{route('email-templates.authentication.promo1')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('promo2') ? 'active' : ''}}" href="{{route('email-templates.authentication.promo2')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link {{ request()->is('promo3') ? 'active' : ''}}" href="{{route('email-templates.authentication.promo3')}}">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('MultiSteps') ? 'active' : ''}}" href="{{route('authentication.multi-steps-sign-up')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('welcome') ? 'active' : ''}}" href="{{route('authentication.welcome')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Welcome Message</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('VerifyEmail') ? 'active' : ''}}" href="{{route('authentication.verify-email')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('ComingSoon') ? 'active' : ''}}" href="{{route('authentication.coming-soon')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('PasswordConfirmation') ? 'active' : ''}}" href="{{route('authentication.password-confirmation')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('AccountDeactivated') ? 'active' : ''}}" href="{{route('authentication.account-deactivated')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('error404') ? 'active' : ''}}" href="{{route('authentication.error-404')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link {{ request()->is('error500') ? 'active' : ''}}" href="{{route('authentication.error-500')}}">
														<span class="menu-bullet">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
